...
// @Component({
// 	selector: 'ggm-temperature-dragger',
...
// 	@ViewChild('svgRoot')
// 	public svgRoot: ElementRef;

// 	@Input() public fillColors: string|string[] = '#2ec6ff';
// 	@Input() public disableArcColor = '#999999';
// 	@Input() public bottomAngle = 90;
// 	@Input() public arcThickness = 18; // CSS pixels
// 	@Input() public thumbRadius = 16; // CSS pixels
// 	@Input() public thumbBorder = 3;
// 	@Input() public maxLeap = 0.4;

// 	public value = 50;
// 	@Output('valueChange') public valueChange = new EventEmitter<Number>();
// 	@Input('value') public set setValue(value: any) {
// 		this.value = value;
// 	}

// 	@Input() public min = 0; // min output value
// 	@Input() public max = 100; // max output value
// 	@Input() public step = 0.1;

// 	@Output() public power = new EventEmitter<boolean>();
...
// 	public svgControlId = new Date().getTime();
